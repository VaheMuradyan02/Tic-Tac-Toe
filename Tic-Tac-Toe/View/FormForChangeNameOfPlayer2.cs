...
{
    public partial class FormForChangeNameOfPlayer2 : Form
    {
        private int previousTextLength = 0;

        public FormForChangeNameOfPlayer2()
        {
            InitializeComponent();
        }
        ...
        private void Save_click(object sender, EventArgs e)
        {
            ...
            FieldInfo labelField = formType.GetField("Player2", BindingFlags.NonPublic | BindingFlags.Instance);
